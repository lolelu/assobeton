...
use App\Models\ComunicatiStampa;

class ComunicatiStampaRepository extends ModuleRepository
{
    use HandleBlocks, HandleSlugs, HandleMedias, HandleFiles, HandleRevisions;

    public function __construct(ComunicatiStampa $model)
    {
        $this->model = $model;
    }
    ...
    public function allPrimaryFeatured()
    {
        ...
        $featured = Feature::whereIn('bucket_key', ['comunicati_primary_feature'])->get();
    ...
    public function allSecondaryFeatured()
    {
        ...
        $featured = Feature::whereIn('bucket_key', ['comunicati_secondary_features'])->get();
